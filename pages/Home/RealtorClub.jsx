...
const RealtorClub = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Emlaksepette.com’ da bulunan proje ilanlarını koleksiyonuna ekleyerek paylaşım yaptığın ilanların satılması durumunda toplam fiyat üzerinden %1 komisyon kazanırsınız. (Örneğin X İnşaat Ofisi firmasının projesindeki bir dairenin fiyatı 10 milyon TL paylaşmış olduğun link üzerinde satılması karşılığında emlaksepette.com emlak kulübü üyesine vergiler düşülerek net 78 bin tl nakit ödeme yapar.) emlaksepette.com’ da bulunan emlak ilanlarını koleksiyonuna ekleyerek paylaşım yaptığın ilanların satılması durumunda toplam fiyat üzerinden %0.5 komisyon kazanırsınız.",
    },
    {
      id: "4",
      question: "Koleksiyona ilan eklemede ve paylaşmada sınır var mı?",
      answer:
        "Emlaksepette.com Paylaştıkça Kazanda ilan paylaşımında sınır yok istediğin kadar ilanı koleksiyonuna ekleyerek paylaş. Paylaşılan ilan sayısı arttıkça kazanma şansın da artar.",
    },
    {
      id: "5",
      question:
        "Paylaştığım linkten gelen kişiler kaç gün içinde satın alma yaparsa benim kazancıma yansır?",
      answer:
        "Oluşturulan paylaştıkça kazan linki üzerinden emlaksepette.com ‘a gelen kullanıcının 24 gün boyunca sistem de link üzerinden geldiği tanınır. 24 gün içinde link paylaşımınızdan satış olması durumunda kazancınıza yansır.",
    },
    {
      id: "6",
      question:
        "Koleksiyonuma eklediğim ilanların linkini paylaştıkdan sonra fiyat değişikliği olursa ne olur?",
      answer:
        "Emlaksepette.com üzerinde bulunan kurumsal mağazalar fiyatı artırması veya düşürmesi durumunda en son güncel fiyat üzerinden komisyon kazanırsınız.",
    },
    {
      id: "7",
      question: "Komisyonumu ne zaman alabilirim?",
      answer:
        "Onaylanan komisyonunuzu, bize belirttiğin hesap bilgilerine ya da kestiğin faturaya istinaden her ayın 15 ile 20’si aralığında yatırıyoruz. Ör. Kasım ayı kazancını (yasal) iptal iade süreci sebebiyle Aralık ayı sonunda tamamlıyoruz, bu doğrultuda Kasım ayı ödemeni en geç Ocak ayının 20‘sine kadar alıyorsunuz.",
    },
    {
      id: "8",
      question: "Komisyon kazancımı ne şekilde alabilirim?",
      answer:
        "Emlaksepette.com Paylaştıkça Kazan kampanyasından elde ettiğin kazancını alabilmen için ödeme bilgilerini eksiksiz ve doğrubir şekilde girmiş olman gerekiyor. Ödeme bilgilerin tamamlanmışsa üyelikte bizlere ilettiğin IBAN veya hesap numarasına kazancın nakit olarak iletilecektir. Emlaksepette.com şahıs ödemeleri kapsamında ilgili kullanıcıların adına gider pusulası düzenleyip, oluşan stopaj maliyetinin ödemesini de kendi tarafında üstlenecektir. Fakat gelir beyanının yapılması, ödemeyi alan kullanıcının kendi sorumluluğunda olup, oluşabilecek her türlü vergi ve yükümlülükler kullanıcının sorumluluğundadır.",
    },
    {
      id: "9",
      question:
        "Paylaştığım ilan iptal ya da iade edildi ise kazancım iptal olur mu?",
      answer:
        "Evet, iptal veya iade edilen ilanlarda kazanç sağlayamazsın. Bir ay içerisinde paylaştığın ürünlerden gelen siparişler iptal ve iade süresi dolduktan sonra kontrol edilip kesinleşmiş satışlar üzerinden kazancın hesaplanır.",
    },
    {
      id: "10",
      question:
        "Kendi linkim üzerinden satın alım yaparak kazanç elde edebilir miyim?",
      answer:
        "Paylaştıkça kazan kampanyasında emlak kulüp üyeleri kendilerine ait linki paylaşarak kendi linklerinden komisyon kazanırlar.",
    },
    {
      id: "11",
      question: "Aydınlatma metnini onaylamadan katılabilir miyim?",
      answer:
        "Emlaksepette.com Paylaştıkça Kazanda gelir elde edebilmek için aydınlatma metnine ve taahütnameye onay vermelisin. Aydınlatma metninin onaylanmadığı durumlarda paylaşım yapılsa da kazanç elde edilemez.",
    },
  ];
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.cardsSection}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardTextContainer}>
            ...
            <Text style={styles.cardText}>
              İlanları koleksiyonuna ekle, kendine uygun koleksiyonlar oluştur
              ve paylaş!
            </Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardTextContainer}>
            ...
            <Text style={styles.cardText}>
              Size özel olarak oluşturulan koleksiyon linkinizi kendi sosyal
              medya hesaplarınızda paylaşın.
            </Text>
          </View>
        </View>
        <View style={styles.divider} />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardTextContainer}>
            ...
            <Text style={styles.cardText}>
              Paylaş Kazan! Oluşturduğun koleksiyonlardan satış yap! Her ilan
              için bizimle beraber sen de kazanırsın.
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.mainSection}>
        ...
        <Text style={styles.mainText}>
          Hızla kazanç elde etmeye başlamak için hemen Emlak Kulüp'e üye olun!
          Beğendiğiniz emlak ve projeleri kolekiyona ekleyip, paylaşarak nakit
          kazanç sağlayın ve sürpriz ödüller kazanma fırsatını yakalayın.
          Üyeliğinizi hemen oluşturun ve kazancınızı artırmaya başlayın!
        </Text>
        <TouchableOpacity
      ...
      <View style={styles.infoSection}>
        ...
        <View style={styles.infoSection2}>
          ...
          <Text style={styles.description}>
            Emlak Kulüp, Emlak Sepette'deki ilanları arkadaşlarınız, aileniz
            veya takipçilerinizle paylaşarak kazanç elde etmenizi sağlayan bir
            satış ortaklığı platformudur. Paylaşım yaptıkça kazancınızı
            artırabilir ve sürpriz ödüller kazanabilirsiniz.
          </Text>
        </View>
      </View>
