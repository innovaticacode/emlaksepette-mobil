  ...
  return (
    <>
      {user.type == 1 ? (
        <View>
          <Text>
            Burası Kurumsal hesapların dosya doğrulama ekranı göremiyoruz diye
            üzülmeyin hesabım bölümünden istediğiniz zaman kurumsal hesap
        ...
        >
            ...
            >
              ...
              >
                ...
                {FormDatas[item.state] && (
                  <Text style={{ color: "#008001", fontSize: 12 }}>
                    Seçildi
                  </Text>
                )}
              </View>
                ...
                >
                  {FormDatas[item.state] ? (
                    FormDatas[item.state]?.slice(-3) == "pdf" ? (
                      ...
                      <Image
                        source={{ uri: FormDatas[item.state] }}
                        style={{
                          width: "100%",
                          height: "100%",
                          borderRadius: 20,
          ...
          <TouchableOpacity
            style={{ backgroundColor: "#EA2A29", padding: 8, borderRadius: 8 }}
            onPress={() => {
              checkDocument();
            }}
          >
