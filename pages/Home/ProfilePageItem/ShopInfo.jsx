...
export default function ShopInfo({data, loading}) {
    ...
    return (
        <ScrollView contentContainerStyle={{height:900}} scrollEnabled={loading?true:false}>
...
<View style={{ gap: 5 }}>
    ...
    <Text style={{ fontWeight: '600' }}>{formattedDate}</Text>
                        ...
                        <View style={[styles.ınformation,{top:10,backgroundColor:'#e7ebee',padding:10,borderWidth:0,borderRadius:5}]}>
                        <Skeleton width={'10%'}  skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}} height={40} children={
                            <View style={{ padding: 10, backgroundColor: '#E92C2A', width: width>400?  '10%':'11%', left: 10, alignItems: 'center',  }}>
                            <Icon name='calendar' size={20} color={'white'}  />
                        </View>
                        }/>
...
<View style={{ gap: 10,}}>
    <Skeleton width={60}height={10}  skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>
   <Skeleton width={70} height={10}  skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>
...
<View style={{ gap: 5 }}>
    <Text>İletişim</Text>
    <Text style={{ fontWeight: '600' }}>Telefon : {data?.data?.phone}</Text>
    <Text style={{ fontWeight: '600' }}>E-Mail : {data?.data?.email} </Text>
                            ...
                            <View style={[styles.ınformation,styles.commentArea,{backgroundColor:'#e7ebee'} ]}>
                            <Skeleton width={'10%'} style={{left:5}} height={40}  skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>

<View style={{ gap: 5 }}>
    <Skeleton width={60} height={10} skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>
    <Skeleton width={80} height={10} skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>
    <Skeleton width={100} height={10} skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>
             ...
             
               {
                loading?
                <>
                    <View style={[styles.ınformation,{top:40},styles.commentArea]}>
...
<View style={{ gap: 5 }}>
    <Text>Konum</Text>
    <Text style={{ fontWeight: '600' }}>{data?.data?.town?.sehir_title}/ {data?.data?.district?.ilce_title}/ {data?.data?.neighborhood?.mahalle_title}</Text>
                             ...
                             <View style={[styles.ınformation,{top:50} ,styles.commentArea,{backgroundColor:'#e7ebee'}]}>

                             <Skeleton animation='pulse' width={40} height={40} style={{left:6}}  rounded skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>
             <View style={{ gap: 5 }}>
                <Skeleton width={40} height={12} skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>
                    <Skeleton width={195} height={12} skeletonStyle={{backgroundColor:'#ced4da' , borderRadius:5}}/>
  ...
  <View style={[{width:'100%',height:150,top:60},styles.shadow]}>
                    {/* <ProfileMap mapData={data}/>   */}
                     ...
                     <Skeleton width={'100%'} height={150} style={{top:60,backgroundColor:'#e0e2e5'}} skeletonStyle={{backgroundColor:'#F0EFF1' , borderRadius:5}}/>
            }
...

            {
                           ...
                           <View style={styles.commentPoint}>
                                       <View style={styles.point}>
                                           ...
                                           <Text style={{top:5,color:'grey',fontWeight:'400'}}>/5</Text>
                                               ...
                                               <Text style={{fontSize:12,textAlign:'center'}}>( { data?.data?.owners.length} Yorum)</Text>
                                       </View>
...

              {
                 ...
                 <View style={{width:'100%'}}>
                     <Text style={{textAlign:'center',color:'red'}}>Bu Mağaza için yorum yapılmadı</Text>
                 </View>
              :
                data?.data?.owners?.map((itemComment,_index)=>(
                  <CommentItem username='' key={_index} comment={itemComment.comment} date={itemComment.created_at} rate={itemComment.rate}/>
                ))
              }
               ...
               <View style={styles.commentArea}>
                       ...
                       <View style={{padding:10}}>
                           ...
                           <View style={styles.commentPoint}>
                                       ...
                                       <View style={[styles.point,{alignItems:'center',gap:5}]}>
                                       <Skeleton width={80} height={30} children={
                                             <View style={{alignItems:'center',display:'flex',flexDirection:'row',justifyContent:'center'}}>
                                             <Text style={{fontSize:25,fontWeight:'bold'}}>4.6</Text>
                                             <Text style={{top:5,color:'grey',fontWeight:'400'}}>/5</Text>
                                             </View>
