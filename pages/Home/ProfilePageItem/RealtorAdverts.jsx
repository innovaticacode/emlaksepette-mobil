  ...
  return (
   ...
   
    {
      objectKeys.map((key,index)=>(
        ...
        m2={`${JSON.parse(housingdata[key].housing_type_data)["squaremeters"]}`}
        roomCount={`${JSON.parse(housingdata[key].housing_type_data)["room_count"]}`}
        floor={`${JSON.parse(housingdata[key].housing_type_data)["floorlocation"]}`}
        image={`${ApiUrl}/housing_images/${JSON.parse(housingdata[key].housing_type_data)['image']}`}
