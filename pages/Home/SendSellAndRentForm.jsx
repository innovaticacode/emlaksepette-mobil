...
const [certificate, setcertificate] = useState('')
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://private.emlaksepette.com/api/cities');
...
const fetchDataCounty = async (value) => {
  try {
    const response = await axios.get(`https://private.emlaksepette.com/api/counties/${value}`);
    return response.data;
  } catch (error) {
    console.error('Hata:', error);
    throw error;
...
// },[city]);
      ...
      const fetchDataNeigbour = async (value) => {
        try {
          const response = await axios.get(`https://private.emlaksepette.com/api/neighborhoods/${value}`)
          return response.data;
        } catch (error) {
          console.error('Hata:', error);
          throw error;
