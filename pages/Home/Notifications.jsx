...
const deleteNotifacte = async () => {
  ...
  try {
    const response = await axios.delete('https://private.emlaksepette.com/api/institutional/notification/delete', {
      headers: {
        Authorization: `Bearer ${user?.access_token}`,
      },
      data: formData,
...
const [deleteAlertForNotification, setdeleteAlertForNotification] = useState(false)
const [selectedNotificateId, setselectedNotificateId] = useState(0)
const [alertFordeleteNotificate, setalertFordeleteNotificate] = useState(false)
...
console.log(selectedNotificateId)
  return (
    ...
    <TouchableOpacity style={{backgroundColor:'#EB2B2E',paddingLeft:20,paddingRight:20,padding:3,borderRadius:5}} onPress={()=>{
  ...
  <ScrollView style={{}}>
    ...
    <AwesomeAlert
            ...
            showProgress={false}
              ...
              title={'Tüm bildirimleri silmek istediğinize eminmisiniz?'}
