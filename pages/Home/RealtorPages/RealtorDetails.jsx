...
export default function PostDetail() {
  ...
  return (
    <SafeAreaView style={{ backgroundColor: "white", flex: 1, paddingTop: 25 }}>
      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", gap: 4, alignItems: "center" }}>
            ...
            <Text style={{ color: "white" }}>{data?.housing?.user?.name}</Text>
            <View
              style={{
                width: 18,
                height: 18,
          ...
          <View style={styles.modalContent6}>
            <View style={{ padding: 10, gap: 10 }}>
              <Text style={{ textAlign: "center" }}>
                #1000{data?.housing?.id} No'lu Konutu Sepete Eklemek İsteiğinize
                Eminmisiniz?
              </Text>
              <View
                style={{
