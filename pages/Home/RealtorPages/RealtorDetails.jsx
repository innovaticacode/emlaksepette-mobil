        ...
        <View
          ...
          >
            ...
            >
              ...
              >
                <Text  style={{ color: tabs === 0 ? "white" : "black",fontSize:12  }}>Özellikler</Text>
              </TouchableOpacity>
              ...
              >
                <Text style={{ color: tabs === 2? "white" : "black" ,fontSize:12 }}>Harita</Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => setTabs(3)}
                style={{
              ...
              >
                <Text style={{ color: tabs === 3 ? "white" : "black" ,fontSize:12 }}>Yorumlar</Text>
              </TouchableOpacity>
