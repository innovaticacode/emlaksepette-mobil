...
const Accordion2 = ({
  ...
  return (
    <View style={[styles.container2, { borderWidth: 0 }]}>
      <TouchableOpacity
        style={[styles.row, { borderWidth: 0, borderBottomWidth: 1 }]}
      ...
      {expanded && (
        <View
          style={[styles.child, { borderWidth: 0, padding: 0, paddingTop: 0 }]}
        >
          {children}
        </View>
      )}
          ...
          <View style={styles.modalContent}>
            <SafeAreaView>
              ...
              >
                ...
                <Text
                  style={{ fontSize: 17, color: "#333", fontWeight: "500" }}
                >
                  Filtrele
                </Text>
                <TouchableOpacity>
              ...
              <View style={{ height: width > 400 ? 700 : 500 }}>
                ...
                >
                  ...
                  <View style={{ padding: 10, paddingTop: 15, gap: 10 }}>
                    <Text style={{ fontSize: 15, color: "#161616" }}>
                      Adres
                    </Text>
                    <View>
                      <Accordion
                  ...
                  <View style={{ padding: 10, gap: 7 }}>
                    ...
                    >
                      <View
                        style={{ padding: 10, gap: 10, alignItems: "center" }}
                      >
                        <Check title="2+1" />
                        <Check title="1+1" />
                        <Check title="3+1" />
