    ...
    <View>
      ...
      <View style={{ paddingTop: 10, gap: 10 }}>
        <View style={{ gap: 6 }}>
          ...
          <TextInput style={{...styles.Input,borderColor : getError('card_number')}} value={creditCartData.card_number} onChangeText={(value) => { setCreditCartData({ ...creditCartData, card_number: value }); handleCreditCardNumberChange(value) }} keyboardType='number-pad' maxLength={19} />
        </View>
        <View style={{ gap: 6 }}>
          <Text style={styles.label}>Kart Sahibin Adı Soyadı</Text>
          <TextInput style={{...styles.Input,borderColor : getError('name')}} value={NameOfCardUser} onChangeText={(value) => setNameOfCardUser(value)} />
        </View>
