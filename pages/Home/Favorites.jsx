...
export default function Favorites() {
  ...
  const fetchFavorites = async () => {
    try {
      ...
      const response = await axios.get(
        "http://192.168.1.102:8000/api/favorites",
        config
      );
  ...
  const deleteRequestWithToken = async () => {
    try {
      const response = await axios.delete(
        "http://192.168.1.102:8000/api/institutional/housing-favorite",
        {
          headers: {
            Authorization: `Bearer ${user.access_token}`,
          },
  ...
  const deleteRequestWithTokenProject = async () => {
    try {
      const response = await axios.delete(
        "http://192.168.1.102:8000/api/institutional/project-favorite",
        {
          headers: {
            Authorization: `Bearer ${user.access_token}`,
          },
  ...
  const deleteSelectedFavorite = async () => {
    ...
    try {
      ...
      const response = await axios({
        method: "delete",
        url: "http://192.168.1.102:8000/api/institutional/favorites/delete",
        data: data,
        headers: {
          Authorization: `Bearer ${user.access_token}`,
        },
                  ...
                  if (favorite?.project) {
                    ...
                    return (
                      <RealtorPostFavorited
                        ...
                        image={
                          "http://192.168.1.102:8000/project_housing_images/" +
                          image
                        }
                        title={
