  ...
  return (
    <ScrollView contentContainerStyle={{ padding: 12, gap: 10 }}>
      ...
      <Modal
        ...
        style={[
          styles.modal,
          { padding: 20, justifyContent: "center", backgroundColor: "#3339" },
        ]}
        animationIn={"fadeIn"}
          ...
          <View>
            <Stack row align="center" spacing={4}>
              <CheckBox
                ...
                title={
                  <Text style={{ color: "#333", fontWeight: "600" }}>1 Ay</Text>
                }
                containerStyle={{
              ...
              <CheckBox
                ...
                uncheckedIcon="circle-o"
                title={
                  <Text style={{ color: "#333", fontWeight: "600" }}>6 Ay</Text>
                }
                containerStyle={{
                  backgroundColor: "transparent",
                  borderWidth: 0,
              ...
              <CheckBox
                ...
                uncheckedIcon="circle-o"
                title={
                  <Text style={{ color: "#333", fontWeight: "600" }}>3 Ay</Text>
                }
                containerStyle={{
                  backgroundColor: "transparent",
                  borderWidth: 0,
