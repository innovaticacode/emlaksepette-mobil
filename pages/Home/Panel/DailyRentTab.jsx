...
const renderScene = ({ route, index }) => {
  switch (route.key) {
    case "first":
      return <GraphicForDailyRent index={index} />;
    case "second":
      return <BalanceForDailyRent index={index} />;
    case "shop":
      return <PendingBalanceDailyRent index={index} />;
    case "area":
      return <RejectBalanceForDaily index={index} />;
    default:
      return null;
  }
};
...
export default function DailyRentTab() {
