...
import GraphicForClupRealtor from "../PagesClubRealtor/GraphicForClupRealtor";
import BalanceClupForRealtor from "../PagesClubRealtor/BalanceClubForRealtor";
import PendingBalanceForclubRealtor from "../PagesClubRealtor/PendingBalanceForclubRealto";
import RejectBalanceClupForRealtor from "../PagesClubRealtor/RejectBalanceForClubRealtor";
...
const renderScene = ({ route, index }) => {
  switch (route.key) {
    case "first":
      return <GraphicForClupRealtor index={index} />
    case "second":
      return <BalanceClupForRealtor index={index} />
    case "shop":
      return <PendingBalanceForclubRealtor index={index} />
    case "area":
      return <RejectBalanceClupForRealtor index={index} />
    default:
      return null;
  }
};
...
export default function ClupTabPanel() {
