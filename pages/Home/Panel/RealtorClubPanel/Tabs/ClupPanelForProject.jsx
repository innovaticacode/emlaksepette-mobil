...
import GraphicForClupProject from "../PagesClubProject/GraphicForClupProject";
import BalanceClupForProject from "../PagesClubProject/BalanceClupForProject";
import PendingBalanceForClupProject from "../PagesClubProject/PendingBalanceForClupProject";
import RejectBalanceForClupProject from "../PagesClubProject/RejectBalanceForClupProject";
...
const renderScene = ({ route, index }) => {
  switch (route.key) {
    case "first":
      return <GraphicForClupProject index={index} />;
    case "second":
      return <BalanceClupForProject index={index} />;
    case "shop":
      return <PendingBalanceForClupProject index={index} />;
    case "area":
      return <RejectBalanceForClupProject index={index} />;
    default:
      return null;
  }
};
...
export default function ClupPanelForProject() {
