...
useEffect(() => {
  ...
  return (
    <>
                 ...
                 <View style={styles.image}>
                     {
                         ...
                         <ImageBackground source={{uri:`https://private.emlaksepette.com/housing_images/${JSON.parse(data?.housing?.housing_type_data).image}`}} style={{width:'100%',height:'100%'}}/>  
                     }
      ...
      {tabs==0 && <CreditCartForReserve  
       setCreditCartData={setCreditCartData}
      creditCartData={creditCartData}
          CompeletePayment={completeCreditCardPay}/> }
      {tabs==1 && <EftForReserve onPress={pickDocument} selectedDocumentName={selectedDocumentName} pdfUri={pdfUri} />}
             <Modal
