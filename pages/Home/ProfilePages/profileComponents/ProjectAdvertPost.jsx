  ...
  return (
    <View style={[style.card, { gap: 5 }]}>
      <View style={{ flexDirection: "row", width: "100%", gap: 10 }}>
        <View style={{ backgroundColor: "grey", width: 90, height: 80,borderRadius:5 }}>
        <ImageBackground source={{uri : apiUrl  +  project.image.replace('public','storage')}} style={{width:'100%',height:'100%'}} resizeMode='cover' borderRadius={5}/>
          ...
          <View style={{ gap: 0 }}>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <View style={{ alignItems: "center", justifyContent: "center" }}>
                <TouchableOpacity
                  style={{}}
                  onPress={() => {Onpress(project.id,project.project_title)}}
                >
            ...
            <Text style={{ fontSize: 10, color: "grey", fontWeight: "600" }}>
              {project?.city?.title} / {project?.county?.ilce_title} / {project?.neighbourhood?.mahalle_title}
            </Text>
          </View>
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
          ...
          <Text style={{ color: "grey", fontSize: 12 }}>{project?.favorite_count}</Text>
        </View>
        <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
          <Icon name="bookmark" color={"#333"} size={13} />
          <Text style={{ color: "grey", fontSize: 12 }}>{project?.sharer_links_count}</Text>
        </View>
        {/* <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
