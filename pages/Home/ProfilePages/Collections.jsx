...
useEffect(() => {
  if (loading) {
    ...
    navigation.setOptions({
      title: namFromGetUser.corporate_type === 'Emlak Ofisi'
        ? 'Portföyler'
        : 'Koleksiyonlar',
    });
  }
      ...
      onPress={()=>{
          settab(0)
              ...
              style={{
                  ...
                  <Text style={{color: tab==0 ? '#EA2C2E':'#404040',fontWeight:'500',textAlign:'center',fontSize:15}}>{namFromGetUser?.corporate_type=='Emlak Ofisi' ? 'Portföyler':'Koleksiyonlar'}</Text>
              </TouchableOpacity>
              ...
              style={{
                  ...
                  <Text style={{color: tab==1 ? '#EA2C2E':'#404040',textAlign:'center',fontSize:15,opacity:namFromGetUser.has_club==0||2||3? 0.5:1}}> {namFromGetUser?.corporate_type=='Emlak Ofisi' ? 'Portföy İstatistikleri':' Koleksiyon İstatistikleri'}</Text>
              </TouchableOpacity>
