...
export default function EditAdvert() {
  ...
  useEffect(() => {
    axios
      .get(
        `http://192.168.18.32:8000/api/project_housings/${Project_Id}?start=${start}&end=${end}` +
          start +
          "&take=" +
          take,
      ...
      <View style={{}}>
        <View style={{ backgroundColor: "#E54242", padding: 10 }}>
          <Text style={{ color: "white" }}>
            {" "}
            Proje İlanlarım / {Project_name} Adlı Projenin Konutları
          </Text>
        </View>
        {/* {
    Array.from({
      ...
      return <Text>fdsfd {index +1}</Text>
        ...
        <View style={styles.table}>
          ...
          >
            ...
            <View style={[styles.cell, { width: 150 }]}>
              <Text>Taksitli Fiyat</Text>
            </View>
            <View style={[styles.cell, { width: 200 }]}>
              <Text>Ara Ödemeler</Text>
            </View>
            <View style={[styles.cell]}>
              <Text>Taksit Sayısı</Text>
            </View>
            <View style={[styles.cell, { width: 150 }]}>
              <Text>Peşinat</Text>
            </View>
            <View style={[styles.cell, { width: 150 }]}>
              <Text>Satış Durumu</Text>
            </View>
          ...
          <ScrollView>
            <View style={styles.row}>
              ...
              <View style={[styles.cell, { width: 150, height: 70 }]}>
                <Text style={{ fontSize: 12 }} numberOfLines={3}>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Commodi laboriosam impedit consectetur harum consequatur qui
                  ratione nobis, minima, iure eaque in ad, amet officia ab.
                  Ipsum maxime vero et fugiat.
                </Text>
              </View>
              <View
                style={[
              ...
              <View style={[styles.cell, { width: 200, height: 70 }]}>
                ...
                >
                  <Text style={{ fontSize: 12, color: "#003cc7" }}>
                    Ara ödemeleri güncelle 0 Adet ara ödeme bulunmakta
                  </Text>
                </TouchableOpacity>
              </View>
              <View
              ...
              >
                ...
                >
                  <Text style={{ fontSize: 12, color: "#1B6C0A" }}>
                    Satışa Açık
                  </Text>
                </View>
                <TouchableOpacity
              ...
              <View style={[styles.cell, { width: 120, gap: 5 }]}>
                ...
                >
                  <Text style={{ fontSize: 12, color: "#B81B01" }}>
                    İlanı Sil
                  </Text>
                </TouchableOpacity>
              </View>
