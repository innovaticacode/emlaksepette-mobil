...
export default function RejectAdverts({header,header2,hidden}) {
    ...
    useEffect(() => {
      axios.get('https://7f24-78-178-52-190.ngrok-free.app/api/get_my_projects?status=3&start='+start+'&take='+take,{ headers: { Authorization: 'Bearer ' + user.access_token } }).then((res) => {
