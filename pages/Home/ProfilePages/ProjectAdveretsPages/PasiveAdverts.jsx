...
export default function PasiveAdverts({header,header2,hidden}) {
    ...
    useEffect(() => {
      axios.get('https://7f24-78-178-52-190.ngrok-free.app/api/get_my_projects?status=0&start='+start+'&take='+take,{ headers: { Authorization: 'Bearer ' + user.access_token } }).then((res) => {
  ...
  return (
    ...
    <View style={styles.container} >
        <View style={{
            ...
            <Text style={styles.headerText}>Pasif İlanlar({projects.length})</Text>
        </View>
    ...
    <Modal
        ...
        >
          <View style={styles.modalContent}>
           ...
           <TouchableOpacity style={{backgroundColor:'#DAFBD0',width:'90%',padding:10,borderRadius:5,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:15,borderWidth:0.4,borderColor:'#1B6C0A94'}}>
            <Text style={{textAlign:'center',color:'#1B6C0A',fontWeight:'bold'}}>Yayına Al</Text>
            <MaterialIcon name='home-edit' size={18} color={'#1B6C0A'}/>
           </TouchableOpacity>
