  ...
  const fetchPermissionUser = async () => {
    try {
      if (user.access_token) {
        ...
        setSells(response.data.boughts);
    ...
    <View style={style.container} onTouchStart={() => Keyboard.dismiss()}>
          ...
          <View style={{ display: "flex", flexDirection: "row", gap: 20 }}>
            <TouchableOpacity
              style={[
                style.TabBarBtn,
                {
                  backgroundColor: Tabs == 0 ? "#ebebeb" : "#E54242",
                  borderWidth: Tabs == 0 ? 1 : 0,
                  borderColor: "#E54242",
                },
              ]}
              onPress={() => setTabs(0)}
            >
              <Text
                style={[
                  style.tabBarText,
                  {
                    color: Tabs === 0 ? "#E54242" : "white",
                    fontWeight: Tabs === 0 ? "600" : "normal",
                  },
                ]}
              >
                Tümü
            ...
            <TouchableOpacity
              style={[
                style.TabBarBtn,
                {
                  backgroundColor: Tabs == 1 ? "#ebebeb" : "#E54242",
                  borderWidth: Tabs == 1 ? 1 : 0,
                  borderColor: "#E54242",
                },
              ]}
              onPress={() => setTabs(1)}
            ...
            <TouchableOpacity
              style={[
                style.TabBarBtn,
                {
                  backgroundColor: Tabs == 2 ? "#ebebeb" : "#E54242",
                  borderWidth: Tabs == 2 ? 1 : 0,
                  borderColor: "#E54242",
                },
              ]}
              onPress={() => setTabs(2)}
      ...
      <ScrollView>
        <View style={style.orders}>
          {sells.map((sell, i) => (
            <Order sell={sell} display={"none"} text={"deneme"} />
          ))}
