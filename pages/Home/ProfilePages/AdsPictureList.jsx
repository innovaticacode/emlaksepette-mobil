...
const [updateAlert, setupdateAlert] = useState(false)
    const UpdatePictureToApı = () => {
      setloadingUpdate(true)
       ...
       apiRequestPostWithBearer(`institutional/store_banner/${SelectedPictureId}`, dad)
         .then((res) => {
           setTimeout(() => {
               Dialog.show({
                   type: ALERT_TYPE.SUCCESS,
               ...
               </View>
                   {
                      ...
                      :
                       StoreBanners?.map((item, _i) => (
                           <AdsPictureItem key={_i} image={item.image} id={item.id} order={item.order} getIdForDelete={getIdForDelete} editBtn={SelectPictureAndOpenSheet} NewImage={ımage} IsSelectImage={IsSelectImage} SelectedPictureId={SelectedPictureId} />
                         ))
