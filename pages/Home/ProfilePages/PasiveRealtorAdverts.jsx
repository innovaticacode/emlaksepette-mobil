        ...
        >
          <View style={styles.modalContent}>
           ...
           <TouchableOpacity style={{backgroundColor:'#DAFBD0',width:'90%',padding:10,borderRadius:5,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:15,borderWidth:0.4,borderColor:'#1B6C0A94'}}>
            <Text style={{textAlign:'center',color:'#1B6C0A',fontWeight:'bold'}}>Düzenle</Text>
           ...
           <TouchableOpacity style={{backgroundColor:'#FFEFCA',width:'90%',padding:10,borderRadius:5,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:15,borderWidth:0.4,borderColor:'#BD3803'}}>
            <Text style={{textAlign:'center',color:'#BD3803',fontWeight:'bold'}}>Loglar</Text>
           ...
           <TouchableOpacity style={{backgroundColor:'#DAFBD0',width:'90%',padding:10,borderRadius:5,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:15,borderWidth:0.4,borderColor:'#BC260F'}}>
            <Text style={{textAlign:'center',color:'#1B6C0A',fontWeight:'bold'}}>Aktife Al</Text>
            <MaterialIcon name='delete-outline' size={18} color={'#1B6C0A'}/>
           </TouchableOpacity>
           </ScrollView>
           </View>
          </View>
