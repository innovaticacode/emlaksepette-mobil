 ...
 const [UpdateSuccess, setUpdateSuccess] = useState(false)
  ...
  const postData = async () => {
    ...
    var formData=new FormData()
      ...
      const response = await axios.post('https://mobil.emlaksepette.com/api/client/profile/update', formData ,{
        headers:{
  ...
  <View style={styles.ProfileEditArea}>
    ...
    >
       <Image source={{uri:`${PhotoUrl}${user.profile_image}`}} style={{width:'100%',height:'100%'}} borderRadius={50} />   
    ...
    <View style={styles.Form}>
          ...
          <View>
            ...
            />
              ...
              <View style={{width:'70%'}}>
              <TextInput style={[styles.Input,{width:'100%',borderRadius:0}]} value={`${phone}` } onChangeText={(value)=>setphone(value)} keyboardType='name-phone-pad'/>
              </View>
      ...
      {selectedLocation && (
        <Marker coordinate={selectedLocation} />
          ...
          <View>
            ...
            <TextInput style={[styles.Input,{color:checked? '#333':'grey'}]} value={mobilPhone} onChangeText={(value)=>setmobilPhone(value)} editable={checked? true: false}/>
            <CheckBox
           checked={checked}
         ...
         />
            ...
            <View style={{paddingLeft:10,display:checked? 'flex':'none',gap:10}}>
                  <TouchableOpacity style={{backgroundColor:'#E54242',padding:10,width:'50%',borderRadius:6}}>
                    <Text style={{textAlign:'center',color:'white'}}>Dosya Seç</Text>
                  </TouchableOpacity>
                  <Text style={{color:'red',fontSize:12}}>Lütfen Belge Formatına Uygun Şeklinde Ekleyiniz</Text>

                  <View style={[styles.card,{gap:15,height:'auto'}]}>
                      <Text>Belge Formatı:</Text>
                      <Text>xxxx mail adresim ve xxxx telefon numarası ile kayıtlı olan üyeliğimdeki</Text>
                      <Text>xxxx mail addresim ve xxxx telefon numarasıyla değiştirilmesini talep ediyorum</Text>
                      <Text>isim soyisim</Text>
                      <Text>İmza</Text>
                      <View style={{width:'100%',alignItems:'center'}}>
                      <View style={{width:250,height:200,alignItems:'center',justifyContent:'center'}}>
                          <Image source={require('./tcpng.png')} style={{width:'100%',height:'100%'}}/>
                      </View>
                      </View>
