...
export default function BasketItem() {
  return (
    ...
    >
      ...
      <View
        style={{ backgroundColor: "grey", width: "100%", height: 0.4, top: 18 }}
      ></View>
      <View
        style={{
          alignItems: "center",
      ...
      >
        ...
        <View
          style={{ backgroundColor: "grey", width: 400, height: 0.4, top: 18 }}
        ></View>
        <Text
          style={{
            fontSize: 17,
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <TouchableOpacity
              style={{ width: "25%", backgroundColor: "#274ABB", height: 50, 
              alignItems:'center',
              justifyContent:'center',
            }}
            >
              <Text style={{fontSize:16,color:'white',fontWeight:'bold'}}>Uygula</Text>
            </TouchableOpacity>
            <TouchableOpacity
            style={{ width: "100%", backgroundColor: "#274ABB", height: 50, 
            alignItems:'center',
            justifyContent:'center',
            marginTop:10
          }}
          >
            <Text style={{fontSize:16,color:'white',fontWeight:'bold'}}>53.000₺ Kapora Öde</Text>
          </TouchableOpacity>
