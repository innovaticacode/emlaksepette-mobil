...
export default function RealtorCardHome({
  ...
  return (
    ...
    <TouchableOpacity style={styles.cardContainer} activeOpacity={0.7} onPress={()=>{
        ...
        <View style={[styles.ımageContainer,{height:'auto'}]}>
            <Text style={{fontSize:14,fontWeight:'600',color:'#0C0C0C'}} numberOfLines={2}>
                {title}
            </Text>
        </View>
        <View style={{flexDirection:'row',gap:5,alignItems:'center'}}>
            <Icon name='location-dot' size={15} color={'#606060'}/>
            <Text style={{fontSize:12,color:'#606060',fontWeight:'500'}}>{location}</Text>
        </View>
