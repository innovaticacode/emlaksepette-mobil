...
export default function SliderBar() {
  ...
  const fetchFeaturedStores = async () => {
    try {
      const response = await axios.get(
        "http://192.168.1.102:8000/api/popular-construction-brands"
      );
  ...
  const firstBrands = [
    {
      text: "Al Sat Acil",
      image: "http://192.168.1.102:8000/images/al-sat-acil-image.png",
      color: "#FF0000",
      url: "",
      isShow: "All",
    },
    {
      text: "Emlak Kulüp",
      image: "http://192.168.1.102:8000/images/emlak-kulup.png",
      color: "#F4A226",
    ...
    {
      text: "Sat Kirala",
      image: "http://192.168.1.102:8000/images/sat-kirala.png",
      color: "#0000FF",
      url: "SellAndRent",
      isShow: "All",
    },
