...
export default function Information({ settings }) {
  ...
  return (
    <View style={[styles.card, styles.shadowProp]}>
      <SettingsItem
        info={"İlan No"}
        numbers={"1000" + settings?.project?.id}
        fontWeight={500}
      />
      <SettingsItem
        info={"İlan Tarihi"}
        numbers={formatDate(settings?.project?.created_at)}
        fontWeight={500}
      />
      <SettingsItem
        info={"Kimden"}
        numbers={settings?.project?.user?.name}
        fontWeight={500}
      />
      <SettingsItem
        info={"İş"}
        numbers={settings?.project?.user?.phone}
        fontWeight={500}
      />
      <SettingsItem
        info={"Cep"}
        numbers={settings?.project?.user?.mobile_phone}
        fontWeight={500}
      />
      <SettingsItem
        info={"Mağaza"}
      ...
      <SettingsItem
        info={"İl-İlçe-Mahalle"}
        numbers={
          settings?.project?.city?.title +
          " / " +
          settings?.project?.county?.ilce_title +
          " / " +
          settings?.project?.neighbourhood?.mahalle_title
        }
        fontWeight={500}
      />
      <SettingsItem
        info={"Yapımcı Firma"}
        numbers={settings?.project?.create_company}
        fontWeight={500}
      />
      <SettingsItem
        info={"Ada"}
        numbers={settings?.project?.island}
        fontWeight={500}
      />
      <SettingsItem
        info={"Parsel"}
        numbers={settings?.project?.parcel}
        fontWeight={500}
      />
      <SettingsItem
        info={"Başlangıç tarihi"}
        numbers={formatDate(settings?.project?.start_date)}
        fontWeight={500}
      />
      <SettingsItem
        info={"Bitiş Tarihi"}
        numbers={formatDate(settings?.project?.project_end_date)}
        fontWeight={500}
      />
      <SettingsItem
        info={"Toplam Konut Sayısı"}
        numbers={settings?.toplamSayi}
        fontWeight={500}
      />
      <SettingsItem
        info={"Satışa Açık Konut Sayısı"}
        numbers={settings?.satisaAcikSayi}
        fontWeight={500}
      />
      <SettingsItem
        info={"Satılan Konut Sayısı"}
        numbers={settings?.satilanSayi}
        fontWeight={500}
      />
      <SettingsItem
        info={"Satışa Kapalı Konut Sayısı"}
        numbers={settings?.satisaKapali}
        fontWeight={500}
      />
      <SettingsItem
        info={"Toplam Proje Alanı m2"}
        numbers={
          settings.project.total_project_area
            ? settings.project.total_project_area
            : "Belirtilmedi"
        }
        fontWeight={500}
